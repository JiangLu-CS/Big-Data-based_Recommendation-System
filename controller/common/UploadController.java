...
package lu.my.mall.controller.common;

import lu.my.mall.common.Constants;
import lu.my.mall.util.MallUtils;
...
public class UploadController {
    ...
    @PostMapping({"/shopman/upload/file"})
    @ResponseBody
    public Result shopmanupload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) throws URISyntaxException {
        String fileName = file.getOriginalFilename();
        String suffixName = fileName.substring(fileName.lastIndexOf("."));
        //生成文件名称通用方法
        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd_HHmmss");
